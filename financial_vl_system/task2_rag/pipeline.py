...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--parse_model", type=str, default="Qwen/Qwen3-VL-4B-Instruct")
    parser.add_argument("--embed_model", type=str, default="Qwen/Qwen3-VL-Embedding-4B")
    parser.add_argument("--rerank_model", type=str, default="Qwen/Qwen3-VL-4B-Instruct")
    parser.add_argument("--answer_base_model", type=str, default="Qwen/Qwen3-VL-4B-Instruct")
